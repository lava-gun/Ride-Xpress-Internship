<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/RideXpress.Master" AutoEventWireup="true" CodeBehind="AddReport.aspx.cs" Inherits="RideXpress_StarterKit.NewReport" %>
    ...
    <section class="first">
        <div class="container">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <!--ASP.NET Label Control goes here-->
                    <asp:Label ID="Datelbl" runat="server" Text="Date of Incidents" AssociatedControlID="Date" CssClass="col-xs-4 control-label"></asp:Label>
                    <div class="col-xs-4">
                        <!--ASP.NET Server Control goes here (TextBox, DropDownList, etc.)-->
